...
#Example - install a specific chrome extenstion (recognized by ID) on the Machine level
New-ChromeExtension -ExtensionID 'ncodfadkoblpfngolndehmjpjepepdao' -Hive Machine
